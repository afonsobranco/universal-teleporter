...
- [ ] Responsive measurements — audit fixed sizes, replace with fluid/clamp values
- [ ] Deploy to GitHub Pages as a standalone hosted page
- [ ] Mobile app — wrap with Capacitor or similar for iOS/Android
- [ ] Edge case review — systematic testing of parsing, cross-category logic, API failure modes
